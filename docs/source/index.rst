...
`PyPI package <https://pypi.org/project/bifunclib/>`_. 
Users can also check `releases <https://github.com/XMU-Kuangnan-Fang-Team/BiFuncLib/releases>`_  to get historical versions.
Welcome to provide your feedback and make contributions to our package, we will be grateful for all the contributors. 
The ways to contact us are provided in :ref:`contributing to BiFuncLib <contribution-label>`.
