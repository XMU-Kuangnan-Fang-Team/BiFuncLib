...
from bimax import bimaxbiclust
...
fun_mat = cc_sim_data()
result = cc_bifunc(fun_mat, delta = 1, alpha = 1, beta = 0, const_alpha = True)
'''
...
from simulation_data import cc_sim_data
fun_mat = cc_sim_data()
res = cc_bifunc_cv(data = fun_mat, delta_list = delta_list, alpha = 1, beta = 0, const_alpha = True)
'''
