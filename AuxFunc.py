...
'''
Vmap1 = pd.read_csv("C:\\Users\\YYBG-WANG\\Desktop\\科研\\4.双聚类(Biclustering)python包\\对照数据\\map\\map1.csv", index_col=0)
Vmap2 = pd.read_csv("C:\\Users\\YYBG-WANG\\Desktop\\科研\\4.双聚类(Biclustering)python包\\对照数据\\map\\map2.csv", index_col=0)
...
PFMainFunc2.create_adjacency(plot=False)
'''
